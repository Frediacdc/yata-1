        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/pos/crm/sale/print/voucher/' + row.id + '/" target="_blank" class="btn btn-danger btn-xs btn-flat" data-toggle="tooltip" title="Imprimir"><i class="fas fa-file-pdf"></i></a> ';
                    return buttons;
                }
            },
        ],
...
$(function () {
    ...
    $('#data tbody')
        .on('click', 'a[rel="detail"]', function () {
            ...
            invoice.push({'id': 'Total Iva', 'name': 'S/.' + row.total_iva});
