        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/pos/frm/debts/pay/delete/' + row.id + '/" data-toggle="tooltip" title="Eliminar registro" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash"></i></a>';
                    return buttons;
                }
            },
            {
    ...
    $('#data tbody')
        .on('click', 'a[rel="payments"]', function () {
            ...
            var tr = tblDebtsPay.cell($(this).closest('td, li')).index(),
                rows = tblDebtsPay.row(tr.row).data();
    ...
    $('#tblPayments tbody')
        .on('click', 'a[rel="delete"]', function () {
            ...
            var tr = tblPaymentsDebtsPay.cell($(this).closest('td, li')).index(),
                rows = tblPaymentsDebtsPay.row(tr.row).data();
